    ...
    if urllib.parse.urlparse(arguments["--url"]).scheme == "https":
        ...
        r = requests.post(
            ...
            headers={
                ...
                # This is a hack - a local test DCS is HTTP only and needs this header to be passed to it manually.
                "X-ssl-client-s-dn": "/C=AU/ST=Some-State/O=Internet Widgits Pty Ltd/CN=DCS Acceptance Test Client Mutual Auth (20190808165306)",
            },
        )
    r.raise_for_status()
